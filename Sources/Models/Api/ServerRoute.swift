...
// MARK: - Interpolation
extension ServerRoute.Api.Route {
...
extension ServerRoute.Api.Route.Interpolation.Single.Route {
...
extension Tagged
where
  RawValue == ServerRoute.Api.Route.Interpolation.Single.Route.Cooling.TwoWay
    .CapacityEnvelope
{
  public init(
