...
extension ServerRoute.Api.Route.Interpolation.Single.Route.Cooling {
  ...
  func respond(request: ServerRoute.Api.Route.Interpolation.Single) async throws ->  InterpolationResponse {
    switch self {
...
fileprivate extension ServerRoute.Api.Route.Interpolation.Single.Route.Cooling {
  
  func interpolate(request: ServerRoute.Api.Route.Interpolation.Single, noInterpolation: NoInterpolation) async throws -> InterpolationResponse {
  ...
  func interpolate(request: ServerRoute.Api.Route.Interpolation.Single, oneWayOutdoor: OneWay) async throws -> InterpolationResponse {
  ...
  func interpolate(request: ServerRoute.Api.Route.Interpolation.Single, oneWayIndoor: OneWay) async throws -> InterpolationResponse {
  ...
  func interpolate(request: ServerRoute.Api.Route.Interpolation.Single, twoWay: TwoWay) async throws -> InterpolationResponse {
...
fileprivate extension ServerRoute.Api.Route.Interpolation.Single {
...
fileprivate struct CoolingInterpolationEnvelope {
  ...
  init(
    ...
    // TODO: Check
    let systemType = request.systemType
...
fileprivate extension ServerRoute.Api.Route.Interpolation.Single.Route.Cooling.TwoWay {
  func outdoorRequest(
...
fileprivate extension ServerRoute.Api.Route.Interpolation.Single.Route.Cooling.OneWay {
