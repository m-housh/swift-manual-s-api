...
fileprivate struct OneWayIndoorView: Renderable {
...
fileprivate struct OneWayOutdoorView: Renderable {
...
fileprivate struct NoInterpolationView: Renderable {
...
fileprivate struct TwoWayView: Renderable {
...
fileprivate struct InterpolationView: Renderable {
  ...
  struct Description {
    ...
    private var exampleUl: Node {
      exampleSubTexts.reduce(into: Node.ul(attributes: [.class("mb-0")])) { ul, string in
        ul.append(ChildOf<Tag.Ul>.li(
          attributes: [.class("ms-4")],
          Node.text(string)).rawValue
        )
      }
    }
