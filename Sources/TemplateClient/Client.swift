...
public struct TemplateClient {
  ...
  public var routeTemplate: (KeyPath<Template.Path, String>) async throws -> ServerRoute.Api.Route.Interpolation.Route
  ...
  public init(
    ...
    routeTemplate: @escaping (KeyPath<Template.Path, String>) async throws -> ServerRoute.Api.Route.Interpolation.Route,
...
extension TemplateClient: TestDependencyKey {
  ...
  public static var testValue: TemplateClient = .init(
    ...
    templateDirectory: unimplemented("\(Self.self).templateDirectory", placeholder: URL.defaultTemplateDirectory)
  )
}
